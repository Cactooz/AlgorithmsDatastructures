...
namespace Dijkstra {
	internal class Graph {
		...
		private class Buckets {
			...
			/// <param name="id">The <see cref="City.id"/> value used for <see cref="Dijkstra.done"/> <see cref="Array"/> index.</param>
			public Buckets(string name, int id) {
